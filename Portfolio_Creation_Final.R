...
sd<-c(sd_an_5,sd_an_10,sd_an_16,sd_an_20,sd_an_25,sd_an_30,sd_an_35,sd_an_40,sd_an_45,sd_an_50,sd_an_55)
cagr<-c(cagr_5,cagr_10,cagr_16,cagr_20,cagr_25,cagr_30,sd_an_35,sd_an_40,sd_an_45,sd_an_50,sd_an_55)
size_no<-c(5,10,16,20,25,30,35,40,45,50,55)
...
size_testing<-rbind(size_1,size_2,size_3,size_4,size_5,size_6,size_7,size_8,size_9,size_10,size_11)
...
ggplot(data=temp_data, aes(x=Date)) +
  ...
  geom_line(aes(y = Van30,colour="Size =35"))+
  geom_line(aes(y = Van30,colour="Size =40"))+
  geom_line(aes(y = Van30,colour="Size =45"))+ylab("Portfolio Value")+labs(title = "Vanilla Portfolio")+theme(plot.title = element_text(hjust = 0.5))+
